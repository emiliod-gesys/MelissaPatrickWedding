...
const translations = {
  es: {
    ...
    admin: {
      ...
      importSuccess: "Se importaron {n} invitado(s) correctamente.",
      importPartial:
        "Se importaron {n} invitado(s). {e} fila(s) con error. Revisa: {details}",
      importFailed: "No se pudo importar el archivo.",
      importNoValidRows: "No hay filas válidas para importar.",
  ...
  de: {
    ...
    admin: {
      ...
      importSuccess: "{n} Gast/Gäste erfolgreich importiert.",
      importPartial:
        "{n} Gast/Gäste importiert. {e} Zeile(n) mit Fehler: {details}",
